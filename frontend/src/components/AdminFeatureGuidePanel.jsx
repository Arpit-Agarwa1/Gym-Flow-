...
export default function AdminFeatureGuidePanel({ tabId }) {
  ...
  return (
    <section
      className="rounded-2xl border border-emerald-200/80 bg-gradient-to-br from-white via-slate-50 to-emerald-50/40 px-5 py-5 shadow-sm ring-1 ring-slate-900/[0.06] md:px-6 dark:border-neon/25 dark:from-charcoal dark:via-elevated dark:to-charcoal dark:shadow-panel dark:ring-neon/15"
